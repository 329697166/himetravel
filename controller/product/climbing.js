define(["controller/product/proNav/proNav",'ui','datapicker','zh-CN2'],function(proNav){
    var climbing = avalon.define({
        ...
        navAction:function (){
            climbinging.navIndex = $(this).index();
        },
        navPrev:function (){
            climbinging.navIndex--;
        },
        navNext:function (){
            climbinging.navIndex++;
        },
        ...
        showStatusSelect:function (e){
            e.stopPropagation()
            climbinging.statusShow=true;
            $(document).off().click(function (){
                climbinging.statusShow=false;
            })
        },
        tableData:[
            //模拟表格数据
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"已上架",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"已上架",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"未上架",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"未上架",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"未上架",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"热点",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"热点",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"热点",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"已删除",editTime:"2016-06-26 09:10"},
            {proName:'【特色游玩】旭川机场至星野 度假村单程接/送机',MasterName:"大宝宝-Jally",time:'2016-06-26 09:00',status:"已删除",editTime:"2016-06-26 09:10"},
        ],
